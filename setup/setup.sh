...
sudo -u tv-streamer bash -c "yay -S --noconfirm --needed curl ffmpeg python python-pip tk gedit librewolf-bin >/dev/null 2>&1" # ">/dev/null 2>&1" to make it silent, "grep -v '^\s*#'" to ignore the comments

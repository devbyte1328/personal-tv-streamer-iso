...
cp tv-streamer.desktop /home/tv-streamer/.config/autostart/tv-streamer.desktop
cp librewolf-kiosk.desktop /home/tv-streamer/.config/autostart/librewolf-kiosk.desktop
...
echo "Detecting GPU and resolving drivers"
lspci | grep -E 'VGA|3D'
